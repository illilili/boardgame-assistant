...
public class BalanceService {
    ...
    /**
     * **[신규 추가]** DB에 저장된 모든 게임 규칙의 간략한 정보를 조회합니다.
     *
     * @return 규칙 정보 목록 (ID, 게임 이름)
     */

    public List<BalanceAnalysisDto.RuleInfo> getAllRules() {

        return gameRuleRepository.findAll().stream()
