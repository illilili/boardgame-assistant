...
import com.boardgame.backend_spring.content.dto.ContentUploadRequestDto;
...
public class ContentController {
    ...
    public ResponseEntity<?> uploadContentFile(
            ...
            @RequestPart("dir") String dirName // 예: "rulebooks", "card-images", "thumbnails" 등
    ) throws IOException {
    ...
    /**
     * 썸네일 이미지 자동 생성 요청
     * @param request ThumbnailGenerateRequest
     * @return 생성된 썸네일 이미지 URL
     */
